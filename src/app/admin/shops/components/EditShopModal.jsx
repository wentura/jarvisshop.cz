...
export default function EditShopModal({ shop, onClose, onUpdate }) {
  const [formData, setFormData] = useState({
    ...
    id_inter: shop.id_inter || "",
    is_visible: shop.is_visible || false,
    is_deleted: shop.is_deleted || false,
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`/api/shops/admin/${shop.id}`, {
        method: "PUT",
        headers: {
